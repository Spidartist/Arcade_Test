    ...
    def on_draw(self):
        ...
        for i, prey in enumerate(self.prey_list):
            for phi in range(-180, 180, 20):
                angle_rad = math.radians(prey.angle + phi)
                arcade.draw_line(prey.center_x, prey.center_y, prey.center_x + 100 * math.sin(angle_rad),
                                 prey.center_y - 100 * math.cos(angle_rad), arcade.color.BLUE, 1)
        ...
        for i, pred in enumerate(self.pred_list):
            for phi in range(-20, 30, 10):
                angle_rad = math.radians(pred.angle + phi)
                arcade.draw_line(pred.center_x, pred.center_y, pred.center_x + 200 * math.sin(angle_rad),
                                 pred.center_y - 200 * math.cos(angle_rad), arcade.color.BLUE, 1)
